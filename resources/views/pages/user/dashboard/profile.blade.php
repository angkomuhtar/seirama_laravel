                            ...
                            <div class="grid md:grid-cols-2 gap-7">
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <input type="text" name="unit_kerja"
                                        value="{{ $asn_data->unit_kerja ?? '' }}" placeholder="Masukkan Unit Kerja"
                                        class="bg-font-100 w-full py-3 px-3 rounded-sm font-Opensans text-xs">
                                    <div class="font-Inter text-xs text-danger-500 pt-2 error-message hidden">
                                        This
                                        is
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <select class="bg-font-100 w-full py-3 px-3 rounded-sm font-Opensans text-xs"
                            ...
                            <div class="grid md:grid-cols-2 gap-7">
                                ...
                                <div class="flex flex-col">
                                    <label for="name"
                                        class="font-Opensans font-light text-sm mb-2 capitalize">Jenis
                                        Usaha</label>
                                    <input type="text" name="jenis_usaha" placeholder="Masukkan jenis usaha"
                    ...
                    <form class="space-y-4" id="typeValidation">
                        <div class="grid grid-cols-2 md:grid-cols-11 gap-7">
                            <div class="col-span-3 flex flex-col">
                                <label for="name" class="font-Opensans font-light text-sm mb-2 capitalize">Unit
                                    Kerja</label>
                                <input type="text" name="unit" placeholder="Masukkan Nomor KTP Anda"
                                    class="bg-font-100 w-full py-3 px-3 rounded-sm font-Opensans text-xs ">
                            </div>
                            <div class="col-span-2 flex flex-col">
                                <label for="name" class="font-Opensans font-light text-sm mb-2 capitalize">Lama
                                    Pelatihan</label>
                            ...
                            <div class="col-span-2 flex flex-col">
                                <label for="name" class="font-Opensans font-light text-sm mb-2 capitalize">Tahun
                                    Pelatihan</label>
                            ...
                            <div class="col-span-3 flex flex-col">
                                ...
                                <input type="text" name="penyelenggara" placeholder="Masukkan Nomor KTP Anda"
                                    value="{{ $profile->ktp }}"
                                    class="bg-font-100 w-full py-3 px-3 rounded-sm font-Opensans text-xs ">
                            </div>
                        </div>
                    ...
                    <form class="space-y-4" id="typeValidation">
                        <div class="grid md:grid-cols-2 gap-7">
                            <div class="flex flex-col">
                                <label for="name"
                                    class="font-Opensans font-light text-sm mb-2 capitalize">Email</label>
                                <input type="text" name="ktp" placeholder="Masukkan Nomor KTP Anda" readonly
                                    value="{{ $user->email }}"
                                    class="bg-font-100 w-full py-3 px-3 rounded-sm font-Opensans text-xs ">
                            </div>
                            <div class="flex flex-col">
                            ...
                            <div class="flex flex-col">
                                <label for="name" class="font-Opensans font-light text-sm mb-2 capitalize">New
                                    Password</label>
