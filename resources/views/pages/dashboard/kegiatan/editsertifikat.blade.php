                ...
                <div class="card-body px-6 pb-6">
                    <div class="p-6">
                        <form enctype="multipart/form-data" class="grid md:grid-cols-2 gap-8" method="POST"
                            action={{ route('admin.kegiatan.sertifikat.update', ['id' => $id]) }}>
                            @csrf
                                    ...
                                    <label>
                                        ...
                                        <span class="w-full h-[40px] file-control flex items-center custom-class">
                                            <span class="flex-1 overflow-hidden text-ellipsis whitespace-nowrap">
                                                <span class="text-slate-400 filename">{{ $data->file }}</span>
                                            </span>
                                            <span
                    ...
                    <div class="p-6">
                        <iframe src="{{ route('admin.kegiatan.sertifikat', ['id' => $id]) }}"
                            class="w-full aspect-[3/2]" frameborder="0"></iframe>
                    </div>
                </div>
            </div>
        </div>
